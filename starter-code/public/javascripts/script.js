document.addEventListener('DOMContentLoaded', () => {
  ...
  $(".randomTest").text(`Today is ${dayList[day]} ${monthList[month]} ${dayOfTheMonth}, ${year}, ${time}`);
}, false);

var currentDay = new Date();
var day = currentDay.getDay(); //06
var month = currentDay.getMonth();
var year = currentDay.getFullYear();
var dayOfTheMonth = currentDay.getDate();
var dt = new Date();
var time = dt.getHours() + ":" + dt.getMinutes();

//JS for the calender for NoteTastic.
